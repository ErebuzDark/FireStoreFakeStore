...
const ProductCard = ({ index, product, onClick }) => {
  return ( 
    <div key={index} className="flex flex-col xl:flex-row justify-between p-6 shadow w-full rounded-md bg-white hover:bg-slate-50 duration-300 group cursor-pointer" onClick={onClick}>
